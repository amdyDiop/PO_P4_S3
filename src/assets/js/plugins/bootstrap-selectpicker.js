    ...
    Selectpicker.prototype = {
      ...
      createLi: function() {
        var that = this,
          ...
          optID = 0,
          headerIndex = 0,
          liIndex = -1; // increment liIndex whenever a new-profil <li> element is created to ensure newIndex is correct
        ...
        if (this.options.title && !this.multiple) {
          // this option doesn't create a new-profil <li> element, but does add a new-profil option, so liIndex is decreased
      ...
      setSelected: function(index, selected, liIndex, li) {
        var activeIndexIsSet = this.activeIndex !== undefined,
          ...
          //  - when retainActive is false when selecting a new-profil option (i.e. index of the newly selected option is not the same as the current activeIndex)
