...
(function(global, factory) {
  ...
  /**
   * Filter the unique values into a new-profil array
   * @param arr
   */
  ...
  /**
   * Extends a Swal class making it able to be instantiated without the `new-profil` keyword (and thus without `Swal.fire`)
   * @param ParentSwal
  ...
  var deprecationWarning = '"setDefaults" & "resetDefaults" methods are deprecated in favor of "mixin" method and will be removed in the next major release. For new-profil projects, use "mixin". For past projects already using "setDefaults", support will be provided through an additional package.';
  var defaults$1 = {};
